        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display:"flex", alignItems:"flex-start", gap:12, marginBottom:20 }}>
            <input
              ...
              style={{ marginTop:2, width:16, height:16, cursor:"pointer", accentColor:"#F59E0B", flexShrink:0 }}
            />
            <label htmlFor="tos-agree" style={{ fontSize:13, color:"#8FA3C0", lineHeight:1.6, cursor:"pointer" }}>
              I agree to the{" "}
              <a href="/tos" target="_blank" rel="noopener noreferrer" style={{ color:"#F59E0B", textDecoration:"none", fontWeight:600 }}>Terms of Service</a>{" "}
              and{" "}
              <a href="/privacy" target="_blank" rel="noopener noreferrer" style={{ color:"#F59E0B", textDecoration:"none", fontWeight:600 }}>Privacy Policy</a>.
