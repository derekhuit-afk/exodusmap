    ...
    <div style={{ minHeight:"100vh", background:"#0A0702", color:"#F0F4FF", fontFamily:"system-ui,sans-serif" }}>
      <nav style={{ borderBottom:"1px solid rgba(255,255,255,0.08)", padding:"20px 32px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <Link href="/" style={{ display:"flex", alignItems:"center", gap:10, textDecoration:"none" }}>
          ...
          <span style={{ fontSize:15, fontWeight:800, color:"#F0F4FF" }}>ExodusMap</span>
        </Link>
        <Link href="/signup" style={{ fontSize:13, color:"#F59E0B", textDecoration:"none", fontWeight:600 }}>Create Account →</Link>
      </nav>

      <div style={{ maxWidth:760, margin:"0 auto", padding:"64px 32px" }}>
        <div style={{ marginBottom:48 }}>
          <div style={{ fontSize:12, color:"#F59E0B", fontWeight:700, letterSpacing:"0.1em", textTransform:"uppercase", marginBottom:12 }}>Legal</div>
        ...
        {[
          ["1. Acceptance of Terms",
           "By creating an account or accessing ExodusMap, you agree to these Terms of Service and all applicable laws. If you do not agree, do not use this service. These terms constitute a binding legal agreement between you and Huit.AI, Inc."],
          ["2. Description of Service",
           "ExodusMap is a subscription-based software platform provided by Huit.AI, Inc. We reserve the right to modify, suspend, or discontinue any aspect of the service at any time with reasonable notice to active subscribers."],
          ...
          ["4. Subscription and Payment",
           "Access to ExodusMap requires an active paid subscription. Subscriptions are billed monthly or annually in advance. All fees are non-refundable except as required by law. We use Stripe for payment processing — by subscribing, you also agree to Stripe's terms of service."],
          ["5. Cancellation",
          ...
          ["8. Intellectual Property",
           "All content, features, and functionality of ExodusMap are owned by Huit.AI, Inc. and are protected by copyright, trademark, and other intellectual property laws. You are granted a limited, non-exclusive, non-transferable license to use the service for your internal business purposes."],
          ["9. Disclaimers",
          ...
          <div key={title} style={{ marginBottom:36, paddingBottom:36, borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
            <h2 style={{ fontSize:18, fontWeight:700, color:"#F59E0B", marginBottom:12 }}>{title}</h2>
            <p style={{ fontSize:15, color:"#C8D4E8", lineHeight:1.8 }}>{body.replace(/{name}/g, "ExodusMap")}</p>
          </div>
        ))}
        ...
        <div style={{ marginTop:48, padding:24, background:"rgba(255,255,255,0.04)", borderRadius:10, border:"1px solid rgba(255,255,255,0.08)" }}>
          <p style={{ fontSize:13, color:"#8FA3C0", textAlign:"center", lineHeight:1.7 }}>
            Questions? Email us at <a href="mailto:legal@huit.ai" style={{ color:"#F59E0B", textDecoration:"none" }}>legal@huit.ai</a>
            &nbsp;·&nbsp; <Link href="/privacy" style={{ color:"#F59E0B", textDecoration:"none" }}>Privacy Policy</Link>
            &nbsp;·&nbsp; <Link href="/" style={{ color:"#F59E0B", textDecoration:"none" }}>Back to ExodusMap</Link>
          </p>
        </div>
      </div>
    </div>
