      ...
      <div style={{ maxWidth:760, margin:"0 auto", padding:"64px 32px" }}>
        ...
        {[
          ...
          ["How We Use Your Information",
           "We use your information to: provide, operate, and improve ExodusMap; process payments and manage subscriptions; send service-related communications (receipts, security alerts, product updates); respond to support requests; and comply with legal obligations. We do not use your data for advertising."],
          ["Data Sharing",
          ...
          ["Children's Privacy",
           "ExodusMap is not directed to individuals under 18 years of age. We do not knowingly collect personal information from minors. If we learn that we have collected personal information from a minor, we will delete it promptly."],
        ...
        <div style={{ marginTop:48, padding:24, background:"rgba(255,255,255,0.04)", borderRadius:10, border:"1px solid rgba(255,255,255,0.08)" }}>
          <p style={{ fontSize:13, color:"#8FA3C0", textAlign:"center", lineHeight:1.7 }}>
            Questions? Email us at <a href="mailto:privacy@huit.ai" style={{ color:"#F59E0B", textDecoration:"none" }}>privacy@huit.ai</a>
            &nbsp;·&nbsp; <Link href="/tos" style={{ color:"#F59E0B", textDecoration:"none" }}>Terms of Service</Link>
